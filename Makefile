.PHONY: all build clean test master mapper reducer merge_unsalt make_zipf make_catastrophe init_pagerank make_zipf_graph make_skewed_graph merge_unsalt_pagerank analyze_heavy
